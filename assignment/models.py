...
from course.models import Content, Content
...
class Assignment(models.Model):
	...
	student_work = models.ManyToManyField(Student, through='StudentWork')
...
class QuestionBank(models.Model):
	...
	status = models.CharField(max_length=1, default='a')
	assignment_quest = models.ManyToManyField(Assignment, through="AssignmentQuestion")
